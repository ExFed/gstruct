...
class RefTest {
    ...
    static final Ref FOO_BAR_LAZY = Ref.lazy("foo", () -> extern("bar"));
    static final Ref FOO_BAZ_LAZY = Ref.lazy("foo", () -> extern("baz"));
    static final Ref BIZ_BAZ_LAZY = Ref.lazy("biz", () -> extern("baz"));
    static final Ref FOO_BAR_EAGER = ((Ref.Supplied) FOO_BAR_LAZY).asEager();
    static final Ref FOO_BAZ_EAGER = ((Ref.Supplied) FOO_BAZ_LAZY).asEager();
    static final Ref BIZ_BAZ_EAGER = ((Ref.Supplied) BIZ_BAZ_LAZY).asEager();
